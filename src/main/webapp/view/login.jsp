            ...
            <form class="row g-3">
                <div class="col-md-12">
                    <div class="row m-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="validationDefault01" placeholder="Juanito"
                                   required>
                        </div>
                    </div>
                    <div class="row m-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="validationDefault02" placeholder="Perez"
                                   required>
                        </div>
                    </div>
                    <div class="row m-4">
