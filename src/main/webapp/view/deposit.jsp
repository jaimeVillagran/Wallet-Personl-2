...
<div class="container">
    <div class="container-main row justify-content-center">
        <div class="col-md-6">
            <h2 class="text-center mt-5">Realizar Deposito</h2>
            <p class="text-center mt-5">Tu aplicación confiable para
                gestionar transacciones financieras de manera segura y eficiente.</p>
